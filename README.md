...
Current development version: **v0.8.0-alpha.5**
...
Streamer Mission Control 0.8.0-alpha.5 includes a signed in-app updater powered by NetSparkle's core library. Users can check for updates, choose Update Now, snooze reminders, or view release notes from the Update Center.
