...
This guide takes **Nerdspace Labs OBS Ground Control 0.7.0-alpha.9** from the source folder to a downloadable Windows installer on GitHub.
...
- **Release Windows** runs when you push a version tag such as `v0.7.0-alpha.9`.

The release workflow builds:

- `Nerdspace-OBS-Ground-Control-Setup-v0.7.0-alpha.9.exe` — recommended installer
- `Nerdspace-OBS-Ground-Control-v0.7.0-alpha.9-win-x64.zip` — portable build
...
git init
git add .
git commit -m "OBS Ground Control 0.7.0-alpha.9"
git branch -M main
...
Nerdspace-OBS-Ground-Control-v0.7.0-alpha.9-win-x64.zip
SHA256SUMS.txt
```
...
git tag v0.7.0-alpha.10
git push origin v0.7.0-alpha.10
```
