...
This guide takes **NerdSpace Labs - Streamer Mission Control 0.8.0-alpha.5** from the source folder to a downloadable Windows installer on GitHub.
...
- **Release Windows** runs when you push a version tag such as `v0.8.0-alpha.5`.

The release workflow builds:

- `Nerdspace-OBS-Ground-Control-Setup-v0.8.0-alpha.5.exe` — recommended installer
- `Nerdspace-OBS-Ground-Control-v0.8.0-alpha.5-win-x64.zip` — portable build
...
git init
git add .
git commit -m "Streamer Mission Control 0.8.0-alpha.5"
git branch -M main
...
Nerdspace-OBS-Ground-Control-v0.8.0-alpha.5-win-x64.zip
SHA256SUMS.txt
```
...
```powershell
.\scripts\build-windows-release.ps1 -Version 0.8.0-alpha.5
```
