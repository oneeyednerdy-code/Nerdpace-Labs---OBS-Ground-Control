...
This guide takes **NerdSpace Labs - Streamer Mission Control 0.8.0-alpha.9** from the source folder to a downloadable Windows installer on GitHub.
...
- **Release Windows** runs when you push a version tag such as `v0.8.0-alpha.9`.

The release workflow builds:

- `Nerdspace-OBS-Ground-Control-Setup-v0.8.0-alpha.9.exe` — recommended installer
- `Nerdspace-OBS-Ground-Control-v0.8.0-alpha.9-win-x64.zip` — portable build
...
git init
git add .
git commit -m "Streamer Mission Control 0.8.0-alpha.9"
git branch -M main
...
```text
Nerdspace-OBS-Ground-Control-Setup-v0.8.0-alpha.9.exe
Nerdspace-OBS-Ground-Control-v0.8.0-alpha.9-win-x64.zip
SHA256SUMS.txt
```
...
```powershell
.\scripts\build-windows-release.ps1 -Version 0.8.0-alpha.9
```
