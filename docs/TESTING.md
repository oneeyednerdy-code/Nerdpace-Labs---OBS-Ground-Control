# v0.8.0-alpha.6 Windows Alpha Testing Checklist

## Build / release
- [ ] Windows x64 GitHub Actions build succeeds.
- [ ] No Linux or macOS jobs are present in build/release workflows.
- [ ] Footer shows `NerdSpace Labs by OneEyedNerdy • v0.8.0-alpha.6` for the branch build.
...
## Windows installer regression checks (v0.8.0-alpha.6+)
...
## Self-contained runtime regression checks (v0.8.0-alpha.6+)
...
## Full OBS plugin catalog regression checks (v0.8.0-alpha.6+)
