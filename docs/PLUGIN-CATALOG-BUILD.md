...
Mission Control ships a preloaded snapshot of the official **OBS Studio Plugins** resource category.
...
Mission Control does **not** infer a source repository from search engines, filenames, forks, mirrors, or similarly named projects.
...
The JSON is embedded into the self-contained Windows application at compile time. Mission Control does not need to scrape the OBS website at runtime to display Discover results.
