# GitHub Alpha Release Checklist — 0.8.0-alpha.7
...
- [ ] Footer shows `NerdSpace Labs by OneEyedNerdy • v0.8.0-alpha.7`.
- [ ] OBS detection works.
...
## Public alpha
- [ ] Tag `v0.8.0-alpha.7` is created only after the main artifact is tested.
...
## 0.8.0-alpha.7 creator-bot regression checks
...
## 0.8.0-alpha.7 self-update checks
