# GitHub Alpha Release Checklist — 0.8.0-alpha.2
...
- [ ] Footer shows `NerdSpace Labs by OneEyedNerdy • v0.8.0-alpha.2`.
- [ ] OBS detection works.
...
## Public alpha
- [ ] Tag `v0.8.0-alpha.2` is created only after the main artifact is tested.
...
## 0.8.0-alpha.2 creator-bot regression checks
